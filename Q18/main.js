...
var ideal_places = ["Eiffel Tower", "Statue of Liberty", "Silicon Vally", "Badshahi Mosque", "Hagia Sofia Mosque"];
//• Print your array in its original order.
console.log("Original List");
console.log(ideal_places);
//• Print your array in alphabetical order without modifying the actual list.
console.log("Alphabetical order without modification of original list");
var sortedArray = ideal_places.slice().sort();
...
var reversed_array = ideal_places.slice().reverse();
...
var reversed_actual_array = ideal_places.reverse();
...
var reversed_actual_array2 = ideal_places.reverse();
...
var sorted_final_array = ideal_places.sort();
console.log(ideal_places);
...
var reversed_final_array = ideal_places.reverse();
console.log(ideal_places);
