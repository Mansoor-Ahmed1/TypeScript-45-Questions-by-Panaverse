...
//these items.
var miscellaneous = ["Pakistan", "Next.js", "Chinese", "K-2", "Indus River", "Karachi", "Mumbai", "French", "USA"];
console.log("Following are miscellaneous things, I included in the list", miscellaneous);
